...
REM
REM Generated by Vivado on Mon May 04 22:44:53 +0200 2026
...
echo "xvhdl --incr --relax -prj tb_us_to_cm_vhdl.prj"
call xvhdl  --incr --relax -prj tb_us_to_cm_vhdl.prj -log xvhdl.log
