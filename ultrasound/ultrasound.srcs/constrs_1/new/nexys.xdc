...
# -----------------------------------------------
# Pmod Header JA for HCSR04
# -----------------------------------------------

set_property -dict { PACKAGE_PIN G17 IOSTANDARD LVCMOS33 } [get_ports {hctrigpin}];
set_property -dict { PACKAGE_PIN G18 IOSTANDARD LVCMOS33 } [get_ports {hcechopin}];
